...
- [GitHub v1.0.5](https://github.com/pinkpixel-dev/quota/blob/main/quota-vscode/versions/quota-ai-usage-tracker-1.0.5.vsix) (latest published VSIX; `v1.1.1` is prepared locally)
